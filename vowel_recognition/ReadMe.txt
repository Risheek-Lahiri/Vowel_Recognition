...
1. There is one header file "util.h" that contains all the utility function used while vowel recognition. The main file contains the code to run the program.
2. 150 Sample data files are used that are available as "234101042_vowel_utteranceNumber". 
