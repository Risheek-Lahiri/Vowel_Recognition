...
void training(){
	printf(".................................training................................\n");
	char filenames[5][30] = {"Training/234101042_a_0.txt", "Training/234101042_e_0.txt", "Training/234101042_i_0.txt", "Training/234101042_o_0.txt", "Training/234101042_u_0.txt"};//
...
void testing(){
	//testing files
	char filename[5][30] = {"Testing/234101042_a_20.txt", "Testing/234101042_e_20.txt", "Testing/234101042_i_20.txt", "Testing/234101042_o_20.txt", "Testing/234101042_u_20.txt"};
	...
	for(int vl = 0; vl<5; vl++){
		individualCorrect = 0;
		for(int file=20; file<30; file++){
			//reading test file
			read_file(filename[vl]);
			//output
			printf("\nVowel file: %s identified as-------------- ", filename[vl]);
...
int _tmain(int argc, _TCHAR* argv[]){
    //training using 100 recordings of 20 recording/vowel
	training();
